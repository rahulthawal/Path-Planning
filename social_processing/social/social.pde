// Rahul A Thawal Social Force Model Two Objects Passing By.
...
PVector x1,y1,y2,x_11,X_11,x2,r,normal,G;

PVector start,goal,start11,goal11,obstacle;
...
void draw(){
  ...
  // Subtract start11ing position points 
...
float Cpathplan(PVector p,PVector q,PVector o)
{
 ...
 double count=0;
  ...
  { 
     ...
     if(dist_object<=165 && dist_object>0)
     {
        count=log(165/dist_object); 
       
     }
     else if (dist_object>165) 
     {
        count=0;
     }  
